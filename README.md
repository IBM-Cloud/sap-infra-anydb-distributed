# Deployment of a Distributed System for SAP in Virtual Private Cloud using Automation

## Description

This automation solution is designed for the deployment of a distributed system for SAP in VPC using IBM Cloud Schematics or using CLI.
